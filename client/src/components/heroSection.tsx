...
export default function HeroSection() {
    ...
    // Unity 로고 SVG (fill="currentColor" 추가)
    const UnityLogo = () => (
    ...
    // Unreal Engine 로고 SVG (fill="currentColor" 추가)
    const UnrealLogo = () => (
        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100%" height="100%" viewBox="0 0 50 50">
                            ...
                            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                                <div className="orbit-clockwise">
                                    <div className="w-32 h-32 rounded-full flex items-center justify-center border-4"
                                         style={{backgroundColor: '#161616', borderColor: '#13FF00', boxShadow: '0 0 20px rgba(19, 255, 0, 1)'}}>
